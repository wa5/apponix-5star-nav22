...
app.get("/config", (_: express.Request, res: express.Response): void => {
  // Serve checkout page.
  res.send({
    publishableKey: 'pk_test_51MBV77SE28PiHOlHvvDN0uFEkZw2XISQJTqNy3vLhjZWucRTqqG0jzevr1qsV2yeQxnATKHGcRWdRv8GQKHScdEH00ohkD1IMi'
  });
});
  ...
  async (req: express.Request, res: express.Response): Promise<void> => {
    ...
    try {
      event = stripe.webhooks.constructEvent(
        ...
        'sk_test_51MBV77SE28PiHOlHidbV3oyZypjPvpmGjlJO85Q1TovWGh1JMEVo8jMbvxIZlMJZgRIr78BgHzo2MUHRdp7VcPvo00wOUFow9s'
      );
    } catch (err) {
